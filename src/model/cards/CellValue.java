...
public enum CellValue {
    ...
    BRIDGE(new Image("/view/photos/background/road2.png"), new Image("/view/photos/background/road2.png"), new Image("/view/photos/BackGround_Arena/bridge.png"), new Image("/view/photos/BackGround_Arena/bridge.png"), new Image("/view/photos/BackGround_Arena/bridge.png"), new Image("/view/photos/BackGround_Arena/bridge.png"), new Image("/view/photos/BackGround_Arena/bridge.png")),
    ...
    GRASS(new Image("/view/photos/background/grass3.png"), new Image("/view/photos/background/grass3.png"), new Image("/view/photos/BackGround_Arena/grass.png"), new Image("/view/photos/BackGround_Arena/grass.png"), new Image("/view/photos/BackGround_Arena/grass.png"), new Image("/view/photos/BackGround_Arena/grass.png"), new Image("/view/photos/BackGround_Arena/grass.png")),
